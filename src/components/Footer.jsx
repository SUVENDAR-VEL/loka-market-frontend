...
export default function Footer() {
  ...
  const socialLinks = [
    { icon: <InstagramIcon />, href: 'https://instagram.com', label: 'Instagram', color: 'hover:bg-gradient-to-br hover:from-purple-500 hover:via-pink-500 hover:to-orange-400' },
    { icon: <XIcon />, href: 'https://x.com', label: 'X (Twitter)', color: 'hover:bg-black' },
    { icon: <YouTubeIcon />, href: 'https://youtube.com', label: 'YouTube', color: 'hover:bg-red-600' },
    { icon: <FacebookIcon />, href: 'https://facebook.com', label: 'Facebook', color: 'hover:bg-blue-600' },
    { icon: <LinkedInIcon />, href: 'https://linkedin.com', label: 'LinkedIn', color: 'hover:bg-blue-700' },
  ];

  return (
    <footer className="bg-dark-lighter pt-20 pb-10 border-t border-white/5 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div className="flex items-center gap-3 flex-wrap">
              {socialLinks.map((social) => (
                <a
                  ...
                  className={`w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-slate-300 hover:text-white transition-all duration-300 hover:scale-110 ${social.color}`}
                >
                  {social.icon}
                </a>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/portfolio" className="text-slate-400 hover:text-primary transition-colors">Portfolio</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/services" className="text-slate-400 hover:text-primary transition-colors">Digital Marketing</Link></li>
              <li><Link to="/services" className="text-slate-400 hover:text-primary transition-colors">Web Development</Link></li>
              <li><Link to="/services" className="text-slate-400 hover:text-primary transition-colors">Mobile Apps</Link></li>
              <li><Link to="/services" className="text-slate-400 hover:text-primary transition-colors">Video Production</Link></li>
              <li><Link to="/services" className="text-slate-400 hover:text-primary transition-colors">Branding Strategy</Link></li>
              <li><Link to="/services" className="text-slate-400 hover:text-primary transition-colors">Custom ERP Systems</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-slate-500 text-sm">
            &copy; {currentYear} AthiLoka Agency. All rights reserved.
          </p>
